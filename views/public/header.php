        ...
        <div id="page">
            <div class="header cf">
                ...
                <div class="login header_login">
                    ...
                    <a href="<?php echo URL . 'proizvodi/korpa' ?>" >korpa</a>: <?php $brojProizvoda = !empty($_SESSION['korpa']) ? count($_SESSION['korpa']) : 0; 
                                                                                      echo $brojProizvoda . ' ';
                                                                                      $duzina = strlen($brojProizvoda);
                                                                                      substr($brojProizvoda, -1);
                                                                                      if ( (substr($brojProizvoda, -1) == 1) && $brojProizvoda != 11  ) { 
                                                                                          echo 'proizvod';
                                                                                      } else {
                                                                                          echo 'proizvoda';
                                                                                      }
